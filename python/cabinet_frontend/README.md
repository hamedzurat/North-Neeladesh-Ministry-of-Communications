...
- Patch-panel topology is rescanned every 0.1 seconds by default. The interval
  is configured in `cabinet_frontend/config.py`; once a stable change is found,
  the next frontend exchange sends it to the backend.
