#!/usr/bin/env python3
"""Measure Kokoro streaming latency and produce private listening samples."""
...
def synthesize(
    pipeline: KPipeline, voice: str, text: str
...
def main() -> None:
    ...
    # Discard a complete warm-up inference, including voice loading.
    synthesize(pipeline, args.voice, lines[0]["text"])
